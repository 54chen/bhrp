...
const contractAddress = '0x704172c17D194a00EE9910225b7f295389Ae4D79';//'0x671f8921295a4f582f9296245502508422FBEB92';//'0x1D162cc9d194204Bed89D95e8d7eB64Dfb6ca307';
const contractABI = abi.abi;

const HMTAddress = '0x14D88689465Aa95Ca7474b35Bb3b2E8Aa6cc51CF';
const HMTABI = HMT.abi;

const HGTAddress = '0x3a94271B6F050f8EEcF0F8E53239846b9EfBe97c';
...
export async function getWhoPaid(id) {
  try {
    ...
    if (ethereum) {
       ...
       */
      const whos = await wavePortalContract.getWhoPaid(id);
      let whosCleaned = [];
      whos.forEach(who => {
        console.log(who.tenant + wave.amount);
        whosCleaned.push({
          address: who.tenant,
...
export async function paid(amount, id) {
  try {
    ...
    if (ethereum) {
      ...
      const approveTxn = await HMTContract.approve(waveContract.address,10)
