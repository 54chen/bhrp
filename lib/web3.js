...
const contractAddress = '0xA448d20D52d0d2F572C34501F79e619a27099b4D';//'0x671f8921295a4f582f9296245502508422FBEB92';//'0x1D162cc9d194204Bed89D95e8d7eB64Dfb6ca307';
...
export async function connectWallet() {
  ...
  if (network !== 4) {
    alert('Please switch network to Ethereum Mainnet(Rinkeby)!' + network);
    return false;
  } else {
    try {
      // Request accounts
...
export function disconnectWallet() {
  return new Promise(async (response) => {
    ...
    window.localStorage.removeItem('ensName');
    console.log('Init Web3Modal first.');
    let web3Modal = await initWeb3Modal();
